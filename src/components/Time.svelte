...
<script lang="ts">
  ...
  export let updateTime: number = 1000;
  ...
  let liveInterval: NodeJS.Timer | undefined = undefined;
  let relativeInterval: NodeJS.Timer | undefined = undefined;
  let relativeValue = 0;

...
export const IconBrandAmongus: Component<ComponentProps<"svg">> = (props) => (
  <svg
  ...
  >
    ...
    <path d="M10.646 12.774c-1.939.396-4.467.317-6.234-.601-2.454-1.263-1.537-4.66 1.423-4.982 2.254-.224 3.814-.354 5.65.214.835.256 1.93.569 1.355 3.281-.191 1.067-1.07 1.904-2.194 2.088z" />

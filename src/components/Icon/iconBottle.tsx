...
export const IconBottle: Component<ComponentProps<"svg">> = (props) => (
  <svg
  ...
  >
    ...
    <path d="M7.003 14.803A2.4 2.4 0 0 0 8 14a2.4 2.4 0 0 1 2-1 2.4 2.4 0 0 1 2 1 2.4 2.4 0 0 0 2 1 2.4 2.4 0 0 0 2-1 2.4 2.4 0 0 1 1-.805" />
  </svg>
);
